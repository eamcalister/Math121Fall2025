...
},
{
  ...
  "number": "3",
  "title": "",
  "body": "  One really neat application of a sum-to product formula comes when you write a sum of two sinuoidal functions with very close periods as a product. For instance, The has a very short period and the has a very long period. The result is a graph that looks like the following:    f(x)=sin(2*x)+sin(2.1*x)          What's really neat is that this allows you to hear this identity at work. This is what causes the wavering sound at the end of this video.   MIT Beats and Resonance     "
}
]
